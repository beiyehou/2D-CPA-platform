...
$page_title = api_plugin_hook_function('page_title', '湖北电网流量可视化');
			...
			<table width="100%">
				<tr>
					...
					<td align="right">
						...
						用户登录<strong><?php print db_fetch_cell("select username from user_auth where id=" . $_SESSION["sess_user_id"]);?></strong> (<a href="<?php echo $config['url_path']; ?>logout.php">注销</a>)&nbsp;
						<?php } ?>
					</td>
				</tr>
			</table>
